...
* To make the software auto-start in X, add to /home/pi/.xsession to start up


* To allow the script to restart the gun, sudo chown root.root test.py && sudo chmod 4755 test.py
